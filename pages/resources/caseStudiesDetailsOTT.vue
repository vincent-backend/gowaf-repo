<template>
  ...
  <CommonHeader1 
    :pre-title="$t('resources.caseStudiesDetailsOTT.header.preTitle')"
    ...
    :title="$t('resources.caseStudiesDetailsOTT.header.title')" :content="$t('resources.caseStudiesDetailsOTT.header.content')"
    :btn="$t('resources.caseStudiesDetailsOTT.header.btn')" href="#" 
    ...
    :showFoot="false"
    :btn2="$t('resources.caseStudiesDetailsOTT.header.btn2')"
    :btn2BorderColor="'#000'"
    :pic="{
      src: '/images/resources/case-studies-details-ott/Resources_Case_Studies_details_OTT_banner_graph_2x.png',
      w: '417px',
      h: '397px',
  ...
  <div class="ad2-container" style="margin-bottom: 90px;">
    <template v-for="(item, index) in $tm('resources.caseStudiesDetailsOTT.ad2Container.items')" :key="index">
      <SolutionsAd2 
        :title="item.title" 
    ...
    <CommonList4 
    v-bind="$tm('resources.caseStudiesDetailsOTT.list')"
  />
