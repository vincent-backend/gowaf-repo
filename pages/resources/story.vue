<template>
  ...
  />
  <CommonHeader1
    :pre-title="$t('resources.story.header.preTitle')"
    :title="$t('resources.story.header.title')"
    :content="$t('resources.story.header.content')"
    btn=""
    href="#"
    hint=""
  ...
  <ProductsDRMCustomers :drmCustomer="$tm('resources.story.drmCustomer')" />
  <ProductsSupportPlan
