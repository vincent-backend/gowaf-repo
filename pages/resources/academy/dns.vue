<template>
    ...
    />
    <CommonHeader1
      :title="$t('resources.academy.dns.header.title')"
      :content="$t('resources.academy.dns.header.content')"
      href="#"
      hint=""
      ...
      :showFoot="false"
      :pic="{
        src: '/images/resources/academy/stream_transcribe_banner_graph@2x.png',
        w: '293px',
        h: '298px',
  
        msrc: '/images/resources/academy/stream_transcribe_banner_graph@2x.png',
        mw: '18.31rem',
        mh: '18.62rem'
      }"
    />
