<template>
  ...
  <CommonHeader1 
    :pre-title="$t('resources.caseStudiesDetailsNexusmods.header.preTitle')"
    ...
    :title="$t('resources.caseStudiesDetailsNexusmods.header.title')" :content="$t('resources.caseStudiesDetailsNexusmods.header.content')"
    :btn="$t('resources.caseStudiesDetailsNexusmods.header.btn')" href="#" 
    ...
    :showFoot="false"
    :btn2="$t('resources.caseStudiesDetailsNexusmods.header.btn2')"
    :btn2BorderColor="'#000'"
    :pic="{
      src: '/images/resources/case-studies-details-nexusmods/Resources_Case_Studies_details_nexusmods_banner_graph_2x.png',
      w: '394px',
      h: '330px',
  ...
  <CommonNumbers style="margin-top: 60px;" 
    :items="$tm('resources.caseStudiesDetailsNexusmods.numbers')"
    :numbersTitle="$t('resources.caseStudiesDetailsNexusmods.numbersTitle')"
  />
  <div class="ad2-container" style="margin-bottom: 90px;">
    <template v-for="(item, index) in $tm('resources.caseStudiesDetailsNexusmods.ad2Container.items')" :key="index">
      <SolutionsAd2 
        :title="item.title" 
    ...
    <CommonList4 
    v-bind="$tm('resources.caseStudiesDetailsNexusmods.list')"
  />
  <ProductsDRMCustomers 
    :drmCustomer="$tm('resources.caseStudiesDetailsNexusmods.drmCustomer')" 
   />
  <Footer />
</template>