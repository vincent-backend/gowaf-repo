<template>
  ...
  />
  <CommonHeader1
    :pre-title="$t('products.optimizer.overview.header.preTitle')"
    :title="$t('products.optimizer.overview.header.title')"
  ...
  <SolutionsAd2
    ...
    :content="$t('products.optimizer.overview.Boost.content')"
    href="#"
