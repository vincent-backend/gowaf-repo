<template>
  ...
  <ProductsCalculate1
    ...
    :itemWidth="'560px'"
    :items="i18ntext.c1items"
    :subs="i18ntext.c1subs"
  />
  <ProductsStorageSupportPlan />
  <ProductsStorageList1
    :subTitle="$t('products.storage.Asia.partnerList.subTitle')"
    :title="$t('products.storage.Asia.partnerList.title')"
