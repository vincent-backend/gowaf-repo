<template>
  ...
  <CommonHeader1 :pre-title="$t('products.storage.Australia.header.preTitle')"
    :title="$t('products.storage.Australia.header.title')" :content="$t('products.storage.Australia.header.content')"
    :btn="$t('products.storage.Australia.header.btn')" href="#" 
    :hint="$t('products.storage.Australia.header.hint')"
  ...
  />
  <CommonNumbers style="margin-top: 80px;" :items="$tm('products.storage.Australia.numbers')" />
  <ProductsExceptionalPerformance 
    ...
    :markerColor="$t('products.storage.Australia.exceptionalPerformance.markerColor')"
    :img="$t('products.storage.Australia.exceptionalPerformance.img')"

   />
  <ProductsNeverHit :isShowTitle="false" :neverHit="$tm('products.storage.Australia.neverHit')" />
  <HomeList1 />
  <SolutionsAd1 :title="$t('products.storage.Australia.HopList.title')" :sub-title="$t('products.storage.Australia.HopList.subTitle')"
    :btn="$t('products.storage.Australia.HopList.btn')" href="#"
  ...
  <CommonList1 
    ...
    :title2="$t('products.storage.Australia.list1.subTitle')"
    :items="$tm('products.storage.Australia.list1.items')" />    
  <ProductsSupportPlan />
  <ProductsCalculate1 
    :isShowTitle="false" 
    :isShowReplicationPoints="false" 
    :itemWidth="'560px'"
    :items="$tm('products.storage.Australia.calculator1.items')"
    :subs="$tm('products.storage.Australia.calculator1.subs')"
    />
  <ProductsStorageSupportPlan />
  <ProductsStorageList1 
    :subTitle="$tm('products.storage.Australia.partnerList.subTitle')"
    :title="$tm('products.storage.Australia.partnerList.title')"
    :list="$tm('products.storage.Australia.partnerList.imgPcList')"
  />
  <ProductsDRMCustomers :drmCustomer="$tm('products.storage.Australia.drmCustomer')" />
  <Footer />
</template>