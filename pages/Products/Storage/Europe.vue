<template>
  ...
  <CommonHeader1 :pre-title="$t('products.storage.Europe.header.preTitle')"
    :title="$t('products.storage.Europe.header.title')" :content="$t('products.storage.Europe.header.content')"
    :btn="$t('products.storage.Europe.header.btn')" href="#" 
