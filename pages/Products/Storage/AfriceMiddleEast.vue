<template>
  ...
  <ProductsStorageList1
    :subTitle="$t('products.storage.AfriceMiddleEast.partnerList.subTitle')"
    :title="$t('products.storage.AfriceMiddleEast.partnerList.title')"
