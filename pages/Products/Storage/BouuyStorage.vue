<template>
  ...
  <ProductsEasyPowerful
    ...
    :ful-items="$tm('products.storage.BouuyStorage.EasyPowerful.items')"
  />
  <CommonNumbers
    is-row
    is-two-row
