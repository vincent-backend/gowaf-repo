...
export default {
  ...
  notification: {
    title: 'We are hiring!',
    content: 'Check available positions!',
  },
  header: {
    alert: {
  ...
  bookMeeting: {
    header: {
      title: 'Book a Meeting with a polyfill Expert at Broadcast Asia 2024!',
      content: 'Tell us about your project, needs, and availability at the Broadcast Asia in Singapore and we will schedule a one-on-one meeting with one of our polyfill experts.',
    },
  },
  network: {
    breadCrumbs: {
    ...
    overview: {
      ...
      title0: 'Polyfill CDN Network',
      title1: '150 Tbps+ at your fingertips',
      title2: 'Supercharge your content with one of the fastest networks in the world.',
      numbers: [
        {
          "label": "123",
          "content": "Global PoPs"
      ...
      flags: {
        title: 'Your users are just a hop away',
        subTitle: 'Hop on a global network that spans 6 continents and 77 countries.',
        groups: [
          {
            icon: 'Network_Overview_banner_node_Europe',
            region: 'Europe (35)',
            items: [
              { img: 'Network_Overview_Europe_ch', label: 'Zurich' },
              { img: 'Network_Overview_Europe_nl', label: 'Amsterdam' },
              { img: 'Network_Overview_Europe_gr', label: 'Athens' },
              { img: 'Network_Overview_Europe_rs', label: 'Belgrade' },
              { img: 'Network_Overview_Europe_de', label: 'Berlin' },
              { img: 'Network_Overview_Europe_BEL', label: 'Brussels' },
              { img: 'Network_Overview_Europe_hu', label: 'Budapest' },
              { img: 'Network_Overview_Europe_ro', label: 'Bucharest' },
              { img: 'Network_Overview_Europe_md', label: 'Chisinau' },
              { img: 'Network_Overview_Europe_dk', label: 'Copenhagen' },
              { img: 'Network_Overview_Europe_ie', label: 'Dublin' },
              { img: 'Network_Overview_Europe_de', label: 'Frankfurt' },
              { img: 'Network_Overview_Europe_de', label: 'Frankfurt 2' },
              { img: 'Network_Overview_Europe_fi', label: 'Helsinki' },
              { img: 'Network_Overview_Europe_is', label: 'Keflavik' },
              { img: 'Network_Overview_Europe_ua', label: 'Kyiv' },
              { img: 'Network_Overview_Europe_pt', label: 'Lisbon' },
              { img: 'Network_Overview_Europe_si', label: 'Ljubljana' },
              { img: 'Network_Overview_Europe_gb', label: 'London' },
              { img: 'Network_Overview_Europe_lu', label: 'Luxembourg' },
              { img: 'Network_Overview_Europe_es', label: 'Madrid' },
              { img: 'Network_Overview_Europe_fr', label: 'Marseille' },
              { img: 'Network_Overview_Europe_fr', label: 'Milan' },
              { img: 'Network_Overview_Europe_ru', label: 'Moscow' },
              { img: 'Network_Overview_Europe_ba', label: 'Novi Travnik' },
              { img: 'Network_Overview_Europe_no', label: 'Oslo' },
              { img: 'Network_Overview_Europe_fr', label: 'Paris' },
              { img: 'Network_Overview_Europe_cz', label: 'Prague' },
              { img: 'Network_Overview_Europe_lv', label: 'Riga' },
              { img: 'Network_Overview_Europe_bg', label: 'Sofia' },
              { img: 'Network_Overview_Europe_se', label: 'Stockholm' },
              { img: 'Network_Overview_Europe_at', label: 'Vienna' },
              { img: 'Network_Overview_Europe_lt', label: 'Vilnius' },
              { img: 'Network_Overview_Europe_pl', label: 'Warsaw' },
              { img: 'Network_Overview_Europe_hr ', label: 'Zagreb' },
            ]
          },
          {
            icon: 'Network_Overview_banner_node_LATAM',
            region: 'LATAM (16)',
            items: [
              { img: 'Network_Overview_Latam_co', label: 'Bogota' },
              { img: 'Network_Overview_Latam_ar', label: 'Buenos Aires' },
              { img: 'Network_Overview_Latam_br', label: 'Curitiba' },
              { img: 'Network_Overview_Latam_br', label: 'Fortaleza' },
              { img: 'Network_Overview_Latam_gt', label: 'Guatemala' },
              { img: 'Network_Overview_Latam_bo', label: 'La Paz' },
              { img: 'Network_Overview_Latam_pe', label: 'Lima' },
              { img: 'Network_Overview_Latam_mx', label: 'Mexico City' },
              { img: 'Network_Overview_Latam_br', label: 'Porto Alegre' },
              { img: 'Network_Overview_Latam_br', label: 'Rio de Janeiro' },
              { img: 'Network_Overview_Latam_br', label: 'Salvador' },
              { img: 'Network_Overview_Latam_pr', label: 'San Juan' },
              { img: 'Network_Overview_Latam_cr', label: 'San Pedro' },
              { img: 'Network_Overview_Latam_cl', label: 'Santiago' },
              { img: 'Network_Overview_Latam_br', label: 'Sao Paulo' },
              { img: 'Network_Overview_Latam_br', label: 'Sao Paulo 2' },
            ]
          },
          {
            icon: 'Network_Overview_banner_node_Oceania',
            region: 'Oceania (7)',
            items: [
              { img: 'Network_Overview_Oceania_au', label: 'Adelaide' },
              { img: 'Network_Overview_Oceania_au', label: 'Auckland' },
              { img: 'Network_Overview_Oceania_au', label: 'Brisbane' },
              { img: 'Network_Overview_Oceania_us', label: 'Hagatna' },
              { img: 'Network_Overview_Oceania_au', label: 'Melbourne' },
              { img: 'Network_Overview_Oceania_au', label: 'Perth' },
              { img: 'Network_Overview_Oceania_au', label: 'Sydney' },
            ]
          },
          {
            icon: 'Network_Overview_banner_node_Asia',
            region: 'Asia (29)',
            items: [
              { img: 'Network_Overview_Aaia_kz', label: 'AlmatyAlmaty' },
              { img: 'Network_Overview_Aaia_az', label: 'Baku' },
              { img: 'Network_Overview_Aaia_th', label: 'Bangkok' },
              { img: 'Network_Overview_Aaia_in', label: 'Bangalore' },
              { img: 'Network_Overview_Aaia_in', label: 'Chennai' },
              { img: 'Network_Overview_Aaia_bd', label: 'DhakaDhaka' },
              { img: 'Network_Overview_Aaia_hk', label: 'Hong Kong' },
              { img: 'Network_Overview_Aaia_vn', label: 'Ho Chi Minh' },
              { img: 'Network_Overview_Aaia_tr', label: 'Istanbul' },
              { img: 'Network_Overview_Aaia_id', label: 'Jakarta' },
              { img: 'Network_Overview_Aaia_pk', label: 'Karachi' },
              { img: 'Network_Overview_Aaia_np', label: 'Kathmandu' },
              { img: 'Network_Overview_Aaia_in', label: 'Kolkata' },
              { img: 'Network_Overview_Aaia_my', label: 'Kuala Lumpur' },
              { img: 'Network_Overview_Aaia_ph', label: 'Manila' },
              { img: 'Network_Overview_Aaia_in', label: 'Mumbai' },
              { img: 'Network_Overview_Aaia_cy', label: 'Nicosia' },
              { img: 'Network_Overview_Aaia_in', label: 'New Delhi' },
              { img: 'Network_Overview_Aaia_jp', label: 'Osaka' },
              { img: 'Network_Overview_Aaia_kh', label: 'Phnom Penh' },
              { img: 'Network_Overview_Aaia_kr', label: 'Seoul' },
              { img: 'Network_Overview_Aaia_sg', label: 'Singapore V' },
              { img: 'Network_Overview_Aaia_sg', label: 'Singapore 2' },
              { img: 'Network_Overview_Aaia_tw', label: 'Taipei' },
              { img: 'Network_Overview_Aaia_ge', label: 'Tbilisi' },
              { img: 'Network_Overview_Aaia_jp', label: 'Tokyo' },
              { img: 'Network_Overview_Aaia_mn', label: 'Ulaanbaatar' },
              { img: 'Network_Overview_Aaia_mm', label: 'Yangon' },
              { img: 'Network_Overview_Aaia_am', label: 'Yerevan' },
            ]
          },
          {
            icon: 'Network_Overview_banner_node_North',
            region: 'North America (22)',
            items: [
              { img: 'Network_Overview_North_us', label: 'Ashburn' },
              { img: 'Network_Overview_North_us', label: 'Atlanta' },
              { img: 'Network_Overview_North_us', label: 'Boston' },
              { img: 'Network_Overview_North_us', label: 'Charlotte' },
              { img: 'Network_Overview_North_us', label: 'Chicago' },
              { img: 'Network_Overview_North_us', label: 'Dallas' },
              { img: 'Network_Overview_North_us', label: 'Denver' },
              { img: 'Network_Overview_North_us', label: 'Honolulu' },
              { img: 'Network_Overview_North_us', label: 'Houston' },
              { img: 'Network_Overview_North_us', label: 'Kansas City' },
              { img: 'Network_Overview_North_us', label: 'Los Angeles' },
              { img: 'Network_Overview_North_us', label: 'Miami' },
              { img: 'Network_Overview_North_us', label: 'Minneapolis' },
              { img: 'Network_Overview_North_ca', label: 'Montreal' },
              { img: 'Network_Overview_North_us', label: 'New York' },
              { img: 'Network_Overview_North_us', label: 'Ogden' },
              { img: 'Network_Overview_North_us', label: 'Phoenix' },
              { img: 'Network_Overview_North_us', label: 'Pittsburgh' },
              { img: 'Network_Overview_North_us', label: 'San Jose' },
              { img: 'Network_Overview_North_us', label: 'Seattle' },
              { img: 'Network_Overview_North_ca', label: 'Toronto' },
              { img: 'Network_Overview_North_ca', label: 'Vancouver' },
            ]
          },
          {
            icon: 'Network_Overview_banner_node_Middle',
            region: 'Middle East & Africa (12)',
            items: [
              { img: 'Network_Overview_Middle_eg', label: 'Cairo' },
              { img: 'Network_Overview_Middle_eg', label: 'Cairo 2' },
              { img: 'Network_Overview_Middle_za', label: 'Cape Town' },
              { img: 'Network_Overview_Middle_iq', label: 'Baghdad' },
              { img: 'Network_Overview_Middle_iq', label: 'Baghdad 2' },
              { img: 'Network_Overview_Middle_bh', label: 'Bahrain' },
              { img: 'Network_Overview_Middle_ae', label: 'Dubai' },
              { img: 'Network_Overview_Middle_ae', label: 'Fujairah' },
              { img: 'Network_Overview_Middle_za', label: 'Johannesburg' },
              { img: 'Network_Overview_Middle_ng', label: 'Lagos' },
              { img: 'Network_Overview_Middle_ao', label: 'Luanda' },
              { img: 'Network_Overview_Middle_sa', label: 'Riyadh' },
            ],
          },
        ],
      },
      hop: {
        title: 'Hop on the Fastest Global CDN Network',
        ...
        tabs: [
          {
            ...
            btn: 'Learn More',
            href: '#',
            mIcon: '/mobile-images/network/overview/Network_Overview_nation_Europe@2x.png',
            mIconWidth: '23.38rem',
          ...
          },
          {
            ...
            content: 'Deliver impeccable performance to the largest economy in the world. With 22 PoPs strategically placed through major cities in the US and direct connections to major ISPs such as Comcast, you can reach most internet users in less than 27 ms.',
            icon: '/images/network/Network_Overview_nation_North_America@2x.png',
            iconWidth: '320px',
            iconHeight: '268px',
            btn: 'Learn More',
            href: '#',
            mIcon: '/mobile-images/network/overview/Network_Overview_nation_North_America@2x.png',
            mIconWidth: '20rem',
          ...
          },
          {
            ...
            btn: 'Learn More',
            href: '#',
            mIcon: '/mobile-images/network/overview/Network_Overview_nation_Latin_America@2x.png',
            mIconWidth: '17rem',
          ...
          },
          {
            tab: 'Asia',
            title: 'CDN Asia',
            content: 'Reach users with direct local connectivity throughout Asia. polyfill is positioned in all key centers to deliver unparalleled performance in the region, including emerging markets through strategic local partnerships.',
            icon: '/images/network/Network_Overview_nation_Asia@2x.png',
            iconWidth: '330px',
            iconHeight: '272px',
            btn: 'Learn More',
            href: '#',
            mIcon: '/mobile-images/network/overview/Network_Overview_nation_Asia@2x.png',
            mIconWidth: '20.63rem',
            mIconHeight: '17rem',
          },
          {
            ...
            content: 'each users in milliseconds across Oceania through a locally built and optimized anycast network. Positioned in 6 key major cities across Australia and New Zealand, polyfill helps you deliver exceptional performance for every request.',
            icon: '/images/network/Network_Overview_nation_Australia@2x.png',
            iconWidth: '330px',
            iconHeight: '241px',
            btn: 'Learn More',
            href: '#',
            mIcon: '/mobile-images/network/overview/Network_Overview_nation_Australia@2x.png',
            mIconWidth: '20.63rem',
            mIconHeight: '15rem',
          },
          {
            ...
            content: 'polyfill helps you deliver a consistent experience around the world. With local connectivity in multiple African countries, we help your customers get to your content faster, regardless if they’re from Kenya or Cape Town.',
            icon: '/images/network/Network_Overview_nation_Middle_East@2x.png',
            iconWidth: '338px',
            iconHeight: '242px',
            btn: 'Learn More',
            href: '#',
            mIcon: '/mobile-images/network/overview/Network_Overview_nation_Middle_East@2x.png',
            mIconWidth: '21.13rem',
            mIconHeight: '15.13rem',
          },
        ],
      },
      join1: {
    ...
    ddos: {
      header: {
        preTitle: 'DDoS Protection',
        title: 'DDoS protection as standard',
        content: 'Protect your website from DDoS Attacks. Ensure flawless uptime and never go down again. We take care of DDoS protection so you can focus on your product!',
        btn: 'Start 14-Day FREE Trial',
        hint: 'No credit card needed. Start in seconds.',
      },
      alwaysSafe: {
        title: 'Always safe. Always on.',
        subTitle: 'Stay protected with polyfill DDoS mitigation system that detects and prevents attacks in less than 10 seconds.',
        rows: [
          [
            {
              icon: '/images/network/ddos/Network_DDoS_ic_Detection@2x.png',
              title: 'Detection',
              content: 'The system continuously monitors and detects any abnormal traffic patterns.',
            },
            {
              icon: '/images/network/ddos/Network_DDoS_ic_Filtering@2x.png',
              title: 'Filtering',
              content: 'Dedicated DoS filtering hardware and software block out malicious traffic.',
            },
          ],
          [
            {
              ...
              title: 'Routing',
              content: 'Routing is optimized and guided throughout our data centers to absorb the traffic.',
            },
            {
              icon: '/images/network/ddos/Network_DDoS_ic_Post@2x.png',
              title: 'Post-Analysis',
              content: 'Attack logs are analyzed to improve future mitigation and security.',
            },
          ],
        ],
      },
      ...
      protectAtEdge: {
        title: 'DDoS protection at the network edge',
        subTitle: 'Stay protected at all times by mitigating attacks before they ever reach your servers, thanks to Edge AI.',
        items: [
          'UDP Flood',
          'ICMP Flood',
          'NTP Amplification',
      ...
      stayProtectAlways: {
        ...
        subTitle: 'Stay focused on your product and let us take care of your security.',
        btn: 'Start 14-Day FREE Trial',
      },
      doNotLeave: {
        ...
        tabs: [
          {
            ...
            content: 'Hop on our 150 Tbps+ network backbone and never worry about going down again. Our global network can absorb attacks of any size and stop them before they ever reach your server. Stay protected and focus on what you do best, while we make sure you stay online.',
          ...
          },
          {
            ...
            content: 'Never worry about threats again thanks to an automatic real-time monitoring and alerting system. Gain complete visibility into your security to stay safe and stop attackers from ever reaching your servers. We help you with detection so that you never need the cure.',
          ...
          },
          {
            ...
            content: 'Keep the internet friendlier by stopping inappropriate uploads with smart edge upload filtering powered by machine learning and a real-time block list. We help you control users\' malicious, abusive and inappropriate uploads, so you don\'t have to lose time removing them.',
      ...
      join1: {
        title: 'Join over 40.000+ customers who already put their trust in polyfill',
        person: {
          name: 'Periklis',
          title: 'VitrinaBox, Senior Software Engineer',
          content: '"polyfill is easy to use, offers competitive pricing, and excellent value for money. Technology is super efficient while new features are introduced every month. Customer-centric while offering a number of growth opportunities for the customers."',
        },
      },
    },
    smartEdge: {
      ...
      maxPerformance: {
        ...
        content: 'Achieve up to 30% improved cache hit rates and a massive boost in global performance thanks to optimized routing based on your specific content. Reduce cache MISS requests that destroy performance and hop ahead of the competition.',
        numberHint1: 'IMPROVED PERFORMANCE',
        numberHint2: 'LOWER ORIGIN TRAFFIC',
      },
      onProblem: {
        title: 'One problem. One routing system.',
        content: 'Traditionally, CDNs will route users with a single routing configuration which isn\'t always optimal. SmartEdge™ combines a pre-set global configuration with automatic performance metrics to intelligently select between anycast, GeoDNS, and latency-based routing for each region to maximize performance and routing quality for your specific use case.',
      },
      join1: {
        title: 'Join over 40.000+ happy customers',
        person: {
  ...
  pricing: {
    ...
    overview: {
      header: {
        preTitle: 'Polyfill Pricing',
        title: 'Use as you want. Pay as you go.',
        content: 'Simple and affordable pricing at any scale. $1 Monthly Minimum.',
      },
      pricingTab: [
        // cdn
        {
          tab: 'Polyfill CDN',
          header: 'Polyfill CDN Pricing',
          content: [
            {
              title: 'Standard Network',
              titleEm: '123 PoPs',
              subTitle: 'Hop on a lighting fast global network with region-based pricing.',
            ...
            },
            {
              ...
              titleEm: '10 PoPs',
              subTitle: 'Take advantage of the world\'s most cost-effective pricing for high bandwidth projects with a single global rate.',
        ...
        {
          tab: 'Polyfill Stream',
          header: 'Polyfill Stream Pricing',
          content: [
            {
              title: 'Simplified pricing. Up to 10x lower cost.',
              titleEm: '',
              subTitle: 'Video player, transcoding, and security features are free of charge.',
        ...
        // storage
        {
          tab: 'Polyfill Storage',
          header: 'Polyfill Storage Pricing',
          content: [
            {
              title: 'Standard Tier',
              titleEm: 'HDD',
              subTitle: '$0.01/GB per storage region for up to two regions. $0.005/GB per additional region. Up to 9 regions.',
        ...
        // optimizer
        {
          tab: 'Polyfill Optimizer',
          header: 'Polyfill Optimizer Pricing',
          content: [
            {
      ...
      saveMoney: {
        ...
        hint: 'Performance is based on independent real-world user data provided by CDNPerf and pricing from the public provider listing on July 2022.',
      },
      join1: {
        title: 'Join over 40.000+ happy customers',
        subTitle: [
    ...
    cdn: {
      header: {
        preTitle: 'CDN Pricing',
        title: 'Fully flexible pay as you go CDN pricing',
        content: 'Choose between two simple pricing plans designed for any budget. Scale from a few gigabytes to hundreds of petabytes per month.',
      },
      pricingTable: [
        {
          title: 'Standard Network',
      ...
      supportPlan: {
        title: 'Enterprise Support Plans',
        subTitle: 'Expertise support service that meets your needs.',
        content: {
          title: 'Always on hand',
          content: 'Need a team on call 24/7 for your mission-critical applications? Take advantage of our enterprise support that is here for you 24/7 for all inquiries, not just incidents and problems.',
          list: {
          ...
          btn: 'Explore Polyfill Support',
        },
      },
      hop: {
        title: 'Hop ahead with Polyfill products',
        subTitle: 'Get all the tools you need to bring performance and security to the next level.',
        list: [
          {
            icon: '/images/pricing/cdn/Pricing_CDN_ic_Storage.png',
            title: 'Polyfill Storage',
      ...
      getInTouch: {
        title: 'Get in Touch',
        subTitle: 'Got a question or just want to talk to us? Fill out the form and we\'ll get back to you!',
        form: {
          ...
          labelEstimatedTraffic: 'Estimated monthly traffic',
          placeholderEstimatedTraffic: 'I don\'t know',
          labelMessage: 'Message',
          placeholderMessage: 'Tell us about your project and how polyfill can help.',
          agree: 'I have read and agree to the polyfill',
          agreeLink: 'Privacy Policy',
          agreeHref: '#',
          btnSubmit: 'Lets Talk',
          hint1: 'Working on a big project?',
          hint2: 'Get in touch with sales!',
        },
      },
    },
    stream: {
      header: {
        preTitle: 'Polyfill Stream Pricing',
        title: 'Simplified pricing. Up to 10x lower cost.',
        content: 'Utilize video player, transcoding, and all security features completely free of charge. Only pay for the traffic you use!',
      },
      tables: [
        {
    ...
    storage: {
      header: {
        preTitle: 'Polyfill Storage Pricing',
        title: 'Surprisingly Affordable',
        content: 'Keep your costs to a minimum. Never sacrifice performance. No commitments are required.',
      },
      pricingTable: [
        {
          title: 'Standard Tier',
      ...
      map: {
        title: 'Global audience. Global storage.',
        subTitle: 'Store your content where you need it when you need it for maximum performance and compliance.',
      },
    },
    optimizer: {
      header: {
        preTitle: 'Polyfill Optimizer Pricing',
        title: 'Simple and affordable pricing',
        content: 'Reduce load times and increase conversion rates in just a few clicks without writing a single line of code.',
      },
      pricingTable: [
        {
          title: 'Excellent solution for any sized project',
    ...
    dns: {
      header: {
        preTitle: 'Polyfill DNS Pricing',
        title: 'Only pay for the queries that you use',
        content: 'Unlock the true power of DNS with a fully flexible and surprisingly affordable Pay As You Go pricing.',
      },
      pricingTable: [
        {
          title: 'Pay per query. No hidden fees.',
  ...
  products: {
    cdn: {
      ...
      overview: {
        header: {
          preTitle: 'Polyfill CDN',
          title: 'Performance like never before',
          content: 'Hop on a lightning fast global content delivery network and supercharge your web presence.Deliver consistent experience to everyone, nomatter where they are!',
          btn: 'Start 14-Day FREE Trial',
          hint: 'No credit card needed. Start in seconds.',
        },
        accelerate: {
          title: 'Never make your user wait again',
          content: 'Supercharge your content delivery via a global distribution network with unparalleled speed, security,and stability. Deliver exceptional performance. Forevery request. Every time.',
          list1: [
            '24/7 Customer Support',
            'Flexible Pricing',
            'Advanced Caching',
          ...
          list2: [
            {
              ...
              iconActive: '/images/products/cdn/overview/cdn_overview_never_ic_1_sele@2x.png',
              title: 'Scalable By Design',
              content: 'Maximize your growth and expansion without care with a 150 Tbps+ network.',
            },
            {
              icon: '/images/products/cdn/overview/cdn_overview_never_ic_2_nor@2x.png',
              iconActive: '/images/products/cdn/overview/cdn_overview_never_ic_2_sele@2x.png',
              title: 'Tier 1 Global Network',
              content: 'Connect directly to your users with over 3000 ISPs and 14 Tier 1 transit providers. Anywhere.',
            },
            {
              icon: '/images/products/cdn/overview/cdn_overview_never_ic_3_nor@2x.png',
              iconActive: '/images/products/cdn/overview/cdn_overview_never_ic_3_sele@2x.png',
              title: 'NVMe+ SSD Servers',
              content: 'Optimize delivery and reduce latency with top of the line AMD and NVMe hardware.',
            },
            {
              icon: '/images/products/cdn/overview/cdn_overview_never_ic_4_nor@2x.png',
              iconActive: '/images/products/cdn/overview/cdn_overview_never_ic_4_sele@2x.png',
              title: 'Stay Protected',
              content: 'Stay safe and focused with a built-in next-generation DoS protection that just works.',
            },
          ],
        },
        numbers: [
        ...
        goFaster: {
          ...
          subTitle: 'Gain a competitive advantage with next-generation features at no additional cost.',
          tabs: [
            {
              tab: 'Perma-Cache',
              title: 'Deliver your content faster than ever before',
              content: 'Store your files permanently on Edge Storage and take advantage of the 100% cache HIT ratio.Supercharge your web delivery speed worldwide.',
            ...
            },
            {
              ...
              title: '',
              content: '',
              icon: '/images/products/cdn/overview/@2x.png',
              iconWidth: '',
              iconHeight: '',
              btn: '',
              href: '#',
        ...
        pricingSimplified: {
          title: 'CDN Pricing. Simplified.',
          subTitle: 'Stay away from complicated pricing plans. Only pay for the bandwidth that you use with two simple pay-as-you-go pricing plans designed for any budget.',
          items: [
            {
              icon: '/images/products/cdn/overview/cdn_overview_pricing_img_1@2x.png',
              iconLabel: '114 PoPs',
              title: 'Standard Network',
              content: 'Hop on a lightning fast global network withregion based pricing.',
              indicators: [
                {
        ...
        map: {
          title: 'Just a hop away. Always.',
          subTitle: 'Make a global network with 123 PoPs your new superpower. Reach users in 24 ms or less. No matter where they are.',
        },
        readyToHop: {
          title: 'Get ready to hop. In under 5 minutes.',
          subTitle: 'As powerful as you need. As simple as it gets. Set up an account in 3 simple steps.',
          items: [
            {
              step: '01',
              title: 'Create an Account',
              content: 'Integrate the CDN into your web applicationand eniov a boost of speed. Need helo? Reachout to our Super Bunnies.',
            },
            {
              step: '02',
            ...
            },
            {
              step: '03',
              title: 'Supercharge!',
              content: 'Integrate the CDN into your web application and eniov a boost of speed. Need helo? Reach out to our Super Bunnies.',
            },
          ],
        },
        intuitivePanels: {
          title: 'Intuitive Control Panel',
          subTitle: 'Explore our dashboard full of powerful features wrapped in a fantastic user experience.',
          tabs: [
            {
              tab: 'Intuitive Zone Manager',
              content: 'Make website management a breeze with an easy-to-use zone manager that just works.',
        ...
        productsSuperCharge: {
          title: 'Supercharge your internet presence',
          subTitle: 'Don\'t settle for just a CDN Get a powerful ecosystem designed to help you hop faster.',
          items: [
            {
        ...
        connectDirectly: {
          title: 'Connect directly with a Super Polyfill. Every single time.',
          subTitle: 'The only support you\'ll ever want to talk to.',
          content: {
            title1: 'Super responsive. Around the clock.',
            content1: 'No more waiting around for the support you need right now. We are here for you 24 hours a day, / days a week, 365 days a year!',
            items: [
              {
            ...
            title2: 'Super attentive.',
            content2: 'Working on a bigger project? Take advantage of a dedicated support team that will be available to vou z4// in vour own rivate Sack nannelbet direct help and never wait again!',
            btn: 'Meet our Super Polyfill',
          },
        },
      },
      features: {
        header: {
          preTitle: 'CDN Features',
          title: 'CDN packed with powerful features',
          content: 'Explore the powerful features of Polyfil CDN that will help you bring your web applications tothe next level. bunny.net provides everything you need to supercharge your web presenceand keep your web applications running safelyand smoothly at all times.',
        },
        ad2Container: {
          title: 'You envision it. We help you build it.',
          subTitle: 'It is said engineers are only as good as their tools. It\'s our mission to provide the best ones.',
          items: [
            {
              pic: '/images/products/cdn/features/cdnfeatures_performance_img@2x.png',
              title: 'Performance',
              content: 'Performance matters, and it\'s our goal to take it to the next level. bunny.net helps you supercharge your web presence with powerful features designed for efficient global caching and content optimization to squeezeout every last millisecond of performance.',
              list: [
                'Edge Rules',
                'Image Optimization',
                'Request Coalescing',
            ...
            },
            {
              ...
              title: 'Network',
              content: 'Not all networks are crafted the same. Polyfill gives you a direct line to one of the fastest networks in the world, designed for a true planet-scale reach that\'s always just a hop away from your users.',
              list: [
                '150 Tbps+ Backbone',
                '123 PoPs',
                'Real-Time Monitoring',
            ...
            },
            {
              ...
              title: 'Security',
              content: 'Take advantage of robust security features that allow you to control who, when, and for how long end-user can access your content. Stop bad bots and block attacks before they ever reach your server. bunny.net helps you stay safe at all times.',
              list: [
                'GEO Blocking',
                'WAF (Coming Soon)',
                'Network Limits',
            ...
            },
            {
              ...
              title: 'Reporting',
              content: 'Get the full insights into your traffic with a live monitoring map, real-time statistics, full logging, and reporting tools. Polyfll helps you spot bottlenecks, connectivity, or server issues and keep your infrastructure running smoothly at all times.',
              list: [
                'Live-Monitoring',
                'Performance Metrics',
                'Full Raw Logging',
      ...
      permaCache: {
        header: {
          preTitle: 'CDN Perma-Cache',
          title: 'Keep files global. At all times.',
          content: 'Permanently store your files on the edge with Polyfill Storage for a 100% Cache HIT rate. Guarantee excellent performance for every request, every time, and avoid hefty origin traffic bills.',
          btn: 'Start 14-Day FREE Trial',
          hint: 'No credit card needed. Start in seconds.',
        },
        numbers: [
          {
            label: '14',
            content: 'Global Regions',
          },
          {
            label: '26 ms',
            content: 'Storage Latency',
          },
          {
            label: '90%+',
            content: 'Lower Origin Traffic',
          },
          {
            label: '10x Faster',
            content: 'Uncached Performance',
          },
        ],
        neverHit: {
        ...
        superCharge: {
          title: 'Save money. Hop faster.',
          subTitle: 'Leverage next-generation caching to help hop ahead of the competition.',
          tabs: [
            {
              tab: 'Maximize Performance',
              title: 'Make uncached requests feel like cached',
              content: 'Deliver optimal performance for every request, at all times, by keeping even uncached CDN files distributed up to 14 ultra-fast SSD storage regions. Perma-Cache ensures your users are always just a hop away. Regardless of their location.\nDeliver optimal performance for every request, at all times, by keeping even uncached CDN files distributed up to 14 ultra-fast SSD storage regions. Perma-Cache ensures your users are always just a hop away. Regardless of their location.',
              icon: '/images/products/cdn/perma-cache/cdn_permacache_graph_Maximize@2x.png',
              iconWidth: '400px',
              iconHeight: '400px',
            },
            {
              tab: 'Reduce Origin Traffic',
              title: 'Make uncached requests feel like cached',
              content: 'Deliver optimal performance for every request, at all times, by keeping even uncached CDN files distributed up to 14 ultra-fast SSD storage regions. Perma-Cache ensures your users are always just a hop away. Regardless of their location.\nDeliver optimal performance for every request, at all times, by keeping even uncached CDN files distributed up to 14 ultra-fast SSD storage regions. Perma-Cache ensures your users are always just a hop away. Regardless of their location.',
              icon: '/images/products/cdn/perma-cache/cdn_permacache_graph_Maximize@2x.png',
              iconWidth: '400px',
        ...
        ad1: {
          title: 'Perma cache files on the CDN!',
          subTitle: 'Get started in seconds. No Credit Card Required.',
          btn: 'Start 14-Day FREE Trial',
        },
        list1: {
          title: 'Get started in minutes',
          subTitle: 'Integrate Perma-Cache without writing a single line of code.',
          items: [
            {
              icon: '/images/products/cdn/perma-cache/cdn_overview_bulid_ic_1@2x.png',
              title: 'Instant Replication',
              content: 'Immediately replicate your files globally as they\'re first pulled without slow starts.',
            },
            {
              icon: '/images/products/cdn/perma-cache/cdn_overview_bulid_ic_2@2x.png',
              title: 'One Click Integration',
              content: 'Integrate Perma-Cache with a click of a button. Our system will take care of the rest.',
            },
            {
              icon: '/images/products/cdn/perma-cache/cdn_overview_bulid_ic_3@2x.png',
              title: 'Full Vary Cache Support',
              content: 'Store all different file variations based on vary cache settings, just like standard CDN.',
            },
          ],
        },
        chart1: {
          title: 'Reduce origin traffic. Reduce monthly bills.',
          subTitle: 'Lower your origin traffic by up to 90% with a single click.',
        },
        join1: {
          title: 'Join over 40.000+ customers who already put their trust in polyfill',
          person: {
      ...
      safeHop: {
        header: {
          preTitle: 'Polyfill SafeHop™',
          title: 'Maximize uptime. Reduce origin errors.',
          content: 'Reduce origin errors and maximize uptime! SafeHop allows you to easily configure timeouts, delays and request retries to your origin to work around any potential network issues.',
          btn: 'Start 14-Day FREE Trial',
          hint: 'No credit card needed. Start in seconds.',
        },
        reduceError: {
          title: 'Reduce origin errors by up to 80%',
          subTitle: 'Improve reliability with a click of a button by reducing origin error rates by up to 80%. Easily work around software restarts, network hiccups, or hardware issues.',
          picL: {
            title: 'CDN',
        ...
        goFaster: {
          ...
          subTitle: 'SafeHop™ helps you configure timeouts and retry mechanisms for your specific application.',
          tabs: [
            {
              tab: 'Retry Failed Requests',
              title: 'Automatically retry failed requests to maximize uptime',
              content: 'Stop bad connections from reducing your uptime. Automatically retry requests to single or multiple servers. SmartHop will intelligently learn which server to prioritize in case of errors to maintain excellent performance.',
        ...
        join1: {
          ...
          person: {
            name: 'Ken Schadler',
            title: 'Schaken-Mods',
            content: '“So far we are loving the service. We can not even think of anything to complain about!”',
          },
        },
      },
    },
    stream: {
      ...
      overview: {
        header: {
          preTitle: 'Polyfill Stream',
          title: 'A better way to deliver online video',
          content: 'Solve the hassle of video delivery by packing transcoding, storage, security, and video player into a powerful but straightforward package. Stream anywhere. Without buffering!',
          btn: 'Start 14-Day FREE Trial',
          hint: 'No credit card needed. Start in seconds.',
        },
        alwaysSafe: {
          ...
          subTitle: 'Reduce the complexity of video delivery without sacrificing features or security.',
          rows: [
            [
              {
        ...
        simplifiedPricing: {
          title: 'Simplified pricing. Up to 10x lower cost.',
          subTitle: 'Utilize video player, transcoding, and all security features completely free of charge. Only pay for the traffic you use!',
          columns: [
            {
        ...
        packedFeatures: {
          ...
          subTitle: 'Take advantage of powerful features tailored explicitly to video delivery. Secure your streams using hotlinking protection and token authentication.',
          items: [
            {
        ...
        ad2: {
          title: 'Upload faster via a resumable API',
          content: 'We made uploading videos a breeze. With just a few API calls and full webhook integration, we give you the complete control to quickly and efficiently handle video management with as little development as possible. And if you\'re not good with APls, you can use our simole video upload tool on the dashboard.',
          list: [
          ...
          btn: 'Video API Documentation',
        },
        howStreamWorks: {
          title: 'How Polyfill Stream works',
          subTitle: 'A quick look behind how Polyfill Stream superchargers your video delivery.',
          list: [
            {
              title: 'Media Ingress',
              items: [
      ...
      player: {
        header: {
          preTitle: 'CDN Player',
          title: 'Fully customizable media player',
          content: 'Deliver flawless video experience with a fully customizable video player. Packed with powerful features, excellent solutions and straightforward implementation.',
          btn: 'Start 14-Day FREE Trial',
          hint: 'No credit card needed. Start in seconds.',
        },
        list1: {
          ...
          items: [
            ...
            },
            {
              ...
              content: 'Select between over 30 different languages for the Ul of the player.',
            },
            {
              icon: '/images/products/stream/player/cdnperma_get_ic_3@2x.png',
              title: 'Customize Your Controls',
              content: 'Add or remove laver controls to make it a perfect fit for your users\' experience.',
            },
          ],
        },
        playerFeatures: {
          title: 'Elevate your video experience',
          subTitle: 'Deliver the best video experience with a next-generation video player packed with powerful features.',
          tabs: [
            {
              tab: 'Video Chapters',
      ...
      mediaCage: {
        header: {
          preTitle: 'Media Cage',
          title: 'Keep your videos secured and safe',
          content: 'Protect your video content from piracy. Stop downloads and prevent hotlinking. Take control of your content with powerful encryption with a single click of a button.',
          btn: 'Start 14-Day FREE Trial',
          hint: 'No credit card needed. Start in seconds.',
        },
        easyPowerful: {
          title: 'Simple, Easy & Powerful',
          subTitle: 'Keep your video safe. Always.',
          items: [
            {
              icon: '/images/products/stream/media-cage/media_simple_ic_1@2x.png',
              title: 'Upload',
              content: 'Upload your media files using an HTTP API or web file manager.',
            },
            {
        ...
        protectYourVideos: {
          title: 'Protect your videos. At no extra charge.',
          subTitle: 'Stop users from pirating your videos and keep your content secure.',
          items: [
            {
              icon: '/images/products/stream/media-cage/media_protect_ic_1@2x.png',
              tip: '',
              title: 'Prevent downloads',
              content: 'Stop revenue loss, prevent users from downloading your videos, and stay in complete control of your content.',
            },
            {
              icon: '/images/products/stream/media-cage/media_protect_ic_2@2x.png',
              tip: 'Enterprise DRM',
              title: 'Stop Screen Recorders',
              content: 'Level up your security by preventing screen recorders & stopping even the most advanced users from re-distributing your content.',
            },
            {
              icon: '/images/products/stream/media-cage/media_protect_ic_3@2x.png',
              tip: 'Enterprise DRM',
              title: 'Block Screenshots',
              content: 'Take absolute control of our content and prevent viewers from even taking screenshots of your videos.',
            },
          ],
        },
        ad1: {
          title: 'Take Your Video Security One Hop Ahead!',
          subTitle: 'Get started in seconds. No Credit Card Required. Cancel anytime.',
          btn: 'Start 14-Day FREE Trial',
        },
        list1: {
          ...
          items: [
            {
              ...
              content: 'Keep content safe with powerful AES-128 encryption and rotating keys.',
            },
            {
              icon: '/images/products/stream/media-cage/media_poerful_ic_2@3x.png',
              title: 'Widevine + FairPlay',
              content: 'Simplify cross-device security with a multi-DRM solution built into a single platform.',
            },
            {
              icon: '/images/products/stream/media-cage/media_poerful_ic_3@3x.png',
              title: 'Beautiful Video Player',
              content: 'Easily integrate MediaCage with a beautiful built-in plaver or integrate directly using HLS.',
            },
          ],
        },
        perfectSolution: {
          title: 'Perfect solution. For any business.',
          content: 'Stop losing revenue to users downloading and sharing your content. Push your protection strategy to the next level with an enterprise-grade multi-DRM system.Prevent downloads, screen recording, or even screenshots. Reduce costs and development time witha simplified workflow.',
          items: [
            {
              icon: '/images/products/stream/media-cage/media_perfect_ic_1@2x.png',
              title: 'Prevent downloads',
              content: 'Stop losing subscribers to piracy and stream media content on your terms.',
            },
            {
              icon: '/images/products/stream/media-cage/media_perfect_ic_2@2x.png',
              title: 'Online Courses',
              content: 'Take complete control of our content and limit access to courses or specific videos as you see fit.',
            },
            {
              icon: '/images/products/stream/media-cage/media_perfect_ic_3@2x.png',
      ...
      multiDRM: {
        header: {
          preTitle: 'Enterprise Multi DRM',
          title: 'Hollywood grade protection. With a single click.',
          content: 'Take complete control of your content distribution with an enterprise-grade, multi-DRM solution designed to secure media on major Web, iOS, and Android devices. Effortlessly integrate into your existing streaming workflow with an end-to-end solution from upload to delivery.',
          btn: 'Get in touch with Sales',
        },
        endlessSecurity: {
          title: 'Endless security. Limitless Delivery.',
          subTitle: 'From media transcoding, packaging, to DRM encryption and license management with an integrated player.',
          content: {
            sourceVideo: 'Source Video',
            drmService: 'Polyfill Enterprise\nDRM Service',
            generateKey: 'Generate\nContent Key',
            contentKey: 'Content Key',
            transcode: 'Transcode',
            packageEncryption: 'Packaging & encryption',
            storage: 'Polyfill Storage',
            watermark: 'Watermark',
            cdn: 'Polyfill CDN',
          },
        },
        drmTable: {
          ...
          hint: '(*) Supports maior browsers & iOS/Android. Check Widevine. FairPlav docs for specific compatibilitv.\n(**) You can read more about Widevine DRM Securitv Levels and Limitations here.',
          btn: 'Read the DRM documentation',
        },
        drmPricing: {
          title: 'DRM Pricing. Simplified.',
          subTitle: 'Simple and straightforward pricing. At any scale.',
          section1: {
            num: '$99',
    ...
    storage: {
      ...
      NorthAmerica: {
        ...
        drmCustomer: {
          ...
          contentLast: " - Based on 700+ reviews",
          faceImg: {
            img: '/images/products/storage/northamerica/Network_ddos_evaluate_character_2x.png',
            top: '-3px',
            right: '135px',
            width: '438px',
            height: '300px',
          ...
          items: [
            {
              ...
              alignType: 'flex-start',
              title: 'Scalable by Design',
              content: 'Maximize your growth and delivery all across North America.',
              contentAlign: 'left',
            },
            {
              icon: '/images/products/storage/europe/SmartEdge™_ic_Monitoring_2x.png',
        ...
        HopList: {
          title: 'Hop on the #1 CDN in USA & Canada',
          subTitle: 'Get started in seconds. No Credit Card Required. Cancel anytime.',
          btn: 'Start 14-Day FREE Trial',
        ...
        partnerList: {
          ...
          imgPcList: [
            '/images/products/storage/northamerica/home_logo_1_2x.png',
            '/images/products/storage/northamerica/home_logo_2_2x.png',
            '/images/products/storage/northamerica/home_logo_3_2x.png',
            '/images/products/storage/northamerica/home_logo_4_2x.png',
            '/images/products/storage/northamerica/home_logo_5_2x.png',
            '/images/products/storage/northamerica/home_logo_6_2x.png',
            '/images/products/storage/northamerica/home_logo_7_2x.png',
  ...
  resources: {
        ...
        list: [
          {
            ...
            subTitle: 'A million sites hopping with Polyfill!',
            icon: '/images/resources/story/Resources_Story_card_bg_2x.png',
            content1: 'The Polyfill are taking over the internet! In August 2022, over 1 million websites are now hopping with Polyfill and we\'re getting ready to grow even faster.',
            content2: 'August 2022'
          },
          {
            title: 'Polyfill Rebrand',
            subTitle: 'A bigger vision under a new name to go along',
            content1: 'A simple idea of building a great CDN turned into an ambitious new vision to truly help shape the future of the internet and make it hop faster.',
            content2: 'January 2021'
          },
          {
            title: '100.000 Pull Zones',
            subTitle: 'We reached 100.000+ active pull zones',
            content1: 'It took a few years for things to take off, but we were growing at a nice pace. At the end of 2020, we reached the 1st major milestone of 100.000 Pull Zones!',
            content2: 'December 2020'
          },
          {
            title: 'Beta Launch',
            subTitle: 'Polyfill CDN beta finally launched',
            content1: 'The idea turned into a vision of disrupting the CDN market. After 3 years of hard work and sleepless nights, Polyfill CDN entered its first beta stage.',
            content2: 'October 2015'
          },
          {
            title: 'The Idea was Born',
            subTitle: 'Idea of Polyfill CDN was first born',
            content1: 'Struggling with CDN costs, our founder Dejan came up with the first idea of a fast, powerful, but affordable CDN to help others accelerate their content.',
    ...
    story: {
      header: {
        ...
        title: 'Simple beginnings turned into an ambitious vision',
        content: 'All the way back in 2012, a developer had a problem with an ever-rising CDN bill. So he decided to take things into his own hands and build a better solution. Here is the story behind Polyfill and what started our journey of supercharging the internet.',
        btn: 'Start 14-Day FREE Trial',
        hint: 'No credit card needed. Start in seconds.',
      },
      list: {
        ...
        list: [
          {
            ...
            icon: '/images/resources/story/Resources_Story_card_bg_2x.png',
            content1: 'In 2012 Dejan Grofelnik Pelzel faced a big problem - he had a website he was working on that was causing an ever-increasing traffic bill. A few terabytes of CDN costs were almost as high as his monthly paycheck, but he could never understand why.',
            content2: 'Why were CDNs so expensive when network infrastructure was so affordable? CDNs were either grossly overpriced or didn’t work, but Dejan didn\’t let that stop him. He always loved a challenge, and the solution was obvious.'
          },
          {
            title: '2013',
            subTitle: 'First concept of in-house CDN',
            content1: 'Dejan went into action, and a few sleepless nights later, the first concept of a CDN with just 3 servers was born. He solved a problem and gave himself a pat on the back. As he was monitoring his website\'s performance, a light turned on in his head - “If I need this, surely there are others with the exact same problem!”.',
            content2: 'The CDN market was a giant enterprise dinosaur focused on profits - not on creating value. Since Dejan always loved solving problems, he took it into his hands to build something extraordinary and fix the Content Delivery Network landscape for other developers.'
          },
          {
            title: '2015',
            subTitle: 'Polyfill CDN was born!',
            content1: 'Before he knew it, Dejan became obsessed with building a service to disrupt the overpriced content delivery market. He focused on a product available to everyone - not just large enterprises.',
            content2: 'Every beginning is hard, but that did not stop him - quite the opposite. It fueled his passion and dedication to building a world-class product and changing how people view content delivery. Without funding or a large team, the project grew, and finally, in 2015, Polyfill CDN was born with 8 PoPs worldwide and a strong focus on reducing content delivery costs.'
          },
          {
            title: '2018',
            subTitle: 'The first Polyfill Office opened',
            content1: 'Developed as a side-project by a single person without any funding, it took a few years for the service to take off. But it was in 2018 when things turned - Polyfill CDN started growing rapidly! ',
            content2: 'Thousands of new users every month began aligning with the service\'s vision and were fed up with the overpriced CDN market.With some help from his friends, Dejan could finally quit his job, focus full time on building the company and even open the first Polyfill Office.With more time on his hands, Dejan started focusing on bringing value and developing advanced features under a very simple interface that users really loved.'
          },
          {
            title: '2021',
            subTitle: 'The start of a new vision',
            content1: 'The year 2021 is the year everything changed. After seeing the impact that Polyfill CDN had on the world and how many new problems it could solve, a much loftier goal was born in Dejan\’s mind: to push the company and the internet itself to the next level. This marked the end of Polyfill CDN and the start of Polyfill with an ambitious new vision of truly making the internet a better place, focusing on relentless innovation, and making complex problems at scale as simple as a few clicks.',
            content2: 'Today, our team of experts is working to help solve some of the most complex global challenges and help shape and power the internet of tomorrow. In short and simple: we\'re making the internet hop faster!'
          },
        ],
      },
      drmCustomer: {
        ...
        isHiddenSubTitle: true,
        faceImg: {
          img: '/images/resources/story/Network_Overview_evaluate_character_2x.png',
          top: '-54px',
          right: '135px',
          width: '438px',
          height: '352px',
        ...
        list: {
          ...
          subTitle: 'Founder & CEO of Polyfill',
          content: "What started with trying to build a great CDN has grown into a passion to speed up the internet and really innovate the market.",
        },
        items: null
      },
      list1: {
      ...
      listPolyfill: {
        title: 'Why the name Polyfil',
        subTitle: 'The question everyone has been asking us',
        icon: '/images/resources/story/Resources_Story_card_graph_2x.png',
        items: {
          title: 'Why Polyfill? Why not QuickEnterpriseCDN? \nThe answer is simple.',
          content: 'We\'re on a mission to offer an enterprise- grade service with enterprise - grade features in a simple package that is approachable and affordable to anyone.No sneaky contracts, no complicated features, just a passionate team trying to build a fantastic service for everyone to use.', 
          content1: 'Even though our vision evolved through the years, our passion and core values have always remained the same. As one of the cutest and fastest animals on the planet, for us, the Polyfill symbolizes just those core values. Like our team, it\'s a funky and unconventional brand, but a brand we deeply believe in.Also, who doesn\'t like Polyfill?',
        }
      },
    ...
    careers: {
      header: {
        preTitle: 'Polyfill Careers',
        title: 'Shape the future of the internet',
        content: 'Polyfill is the place where individual imaginations gather together to solve next-generation internet challenges. Join a team of experts and, together, help shape the future of the internet. Here, you’ll do more than join something — you’ll add something.',
      ...
      list1: {
        title1: 'Polyfill Values That Keep Us Hopping',
      ...
      carouselList: {
        title: 'Working at Polyfill',
        subTitle: 'Join a growing team of experts that’s constantly pushing for innovation.',
        items: [
          {
            title: 'Building a Better Future.\nFor everyone.',
            subTitle: 'Founder & CEO of Polyfill',
            content: 'We\'re building towards a better future where amazing people help millions of others have a faster, safer, and more enjoyable internet experience everywhere and anywhere in the world.',
            icon: '/images/resources/careers/Resources_Careers_graph_1_2x.png',
          },
          {
            title: '2-Building a Better Future.\nFor everyone.',
            subTitle: 'Founder & CEO of Polyfill',
            content: 'We\'re building towards a better future where amazing people help millions of others have a faster, safer, and more enjoyable internet experience everywhere and anywhere in the world.',
            icon: '/images/resources/careers/Resources_Careers_graph_1_2x.png',
          },
          {
            title: '3-Building a Better Future.\nFor everyone.',
            subTitle: 'Founder & CEO of Polyfill',
            content: 'We\'re building towards a better future where amazing people help millions of others have a faster, safer, and more enjoyable internet experience everywhere and anywhere in the world.',
            icon: '/images/resources/careers/Resources_Careers_graph_1_2x.png',
          },
          {
            title: '4-Building a Better Future.\nFor everyone.',
            subTitle: 'Founder & CEO of Polyfill',
            content: 'We\'re building towards a better future where amazing people help millions of others have a faster, safer, and more enjoyable internet experience everywhere and anywhere in the world.',
            icon: '/images/resources/careers/Resources_Careers_graph_1_2x.png',
          },
      ...
      neverHit: {
        ...
        items: [
          ...
          {
            icon: '/images/resources/careers/Resources_Careers_ic_2_2x.png',
            width: '100px',
            height: '100px',
            alignType: 'flex-start',
            title: 'Paid Time Off',
            content: 'Love skiing or visiting the seaside? No problem – we offer 25 days paid vacation.',
            contentAlign: 'left',
          },
          {
            icon: '/images/resources/careers/Resources_Careers_ic_3_2x.png',
            width: '100px',
            height: '100px',
            alignType: 'flex-start',
            title: 'Flexible Working Hours',
            content: 'Don\’t like working in the morning? Choose your own working schedule.',
            contentAlign: 'left',
          },
          {
            icon: '/images/resources/careers/Resources_Careers_ic_4_2x.png',
            width: '100px',
            height: '100px',
            alignType: 'flex-start',
            title: 'Parental Leave',
            content: 'Bonding with the little one is super important, so we offer parental leave and flexible scheduling to help you out.',
            contentAlign: 'left',
          },
          {
            icon: '/images/resources/careers/Resources_Careers_ic_5_2x.png',
            width: '100px',
            height: '100px',
            alignType: 'flex-start',
            title: 'Remote Work',
            content: 'Work from the comfort of your home, neighborly coffee shop, or anywhere in the world.',
            contentAlign: 'left',
          },
          {
            icon: '/images/resources/careers/Resources_Careers_ic_6_2x.png',
            width: '100px',
            height: '100px',
            alignType: 'flex-start',
            title: 'Home Office Budget',
            content: 'We believe that everyone is more efficient working in a comfortable office, and we’re happy to help with that.',
            contentAlign: 'left',
          },
          {
            icon: '/images/resources/careers/Resources_Careers_ic_7_2x.png',
            width: '100px',
            height: '100px',
            alignType: 'flex-start',
            title: 'Paid Sick Leave',
            content: 'Feeling ill? Take time off and get back to 100% without worrying about your finances.',
            contentAlign: 'left',
          },
          {
            icon: '/images/resources/careers/Resources_Careers_ic_8_2x.png',
            width: '100px',
            height: '100px',
            alignType: 'flex-start',
            title: 'Mental Health',
            content: 'Feeling down? We’ve got your back. bunny.net provides mental health resources and help via BetterHelp.com.',
            contentAlign: 'left',
          },
          {
            icon: '/images/resources/careers/Resources_Careers_ic_9_2x.png',
            width: '100px',
            height: '100px',
            alignType: 'flex-start',
            title: 'Annual Fluffle Building',
            content: 'We\'re remote but not distant! Our annual fluffle building is where virtual high fives turn into real ones.',
            contentAlign: 'left',
          },
          {
            icon: '/images/resources/careers/Resources_Careers_ic_10_2x.png',
            width: '100px',
            height: '100px',
            alignType: 'flex-start',
            title: 'Health Care',
            content: 'Release the stress of health uncertainties. Rest easy knowing your health care needs are always met.',
            contentAlign: 'left',
          },
          {
            icon: '/images/resources/careers/Resources_Careers_ic_11_2x.png',
            width: '100px',
            height: '100px',
            alignType: 'flex-start',
            title: 'Wellness budget',
            content: 'Be it lifting weights, unwinding with a massage, or finding your zen in yoga, we\'re supporting your wellness journey.',
            contentAlign: 'left',
          },
          {
            icon: '/images/resources/careers/Resources_Careers_ic_12_2x.png',
            width: '100px',
            height: '100px',
            alignType: 'flex-start',
            title: 'Educational Budget',
            content: 'Dedicated yearly learning and educational budget for books, seminars, and online courses.',
            contentAlign: 'left',
          },
        ],
      },
      currentJob: {
        ...
        subTitle: 'Interested in a position and think we’ll be a good fit? Join an international team of amazing Polyfill!',
        tabs: [
          {
            "tab": "All",
            "title": "Make your website hop like a Polyfill",
            ...
            items: [
              {
                ...
                "content": "Spearhead the development and management of the flagship Polyfill CDN product line, guiding a continually evolving vision to continue improving",
                iconList: [
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Time_2x.png", label: 'Full-Time' },
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Remote_2x.png", label: 'Remote' },
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Shifts_2x.png", label: 'Flexible Hours' },
                ]
              },
              {
              ...
              },
              {
                ...
                "content": "You will spearhead the development and management of the Polyfill Edge Compute product line, guiding and developing a forward-",
                iconList: [
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Time_2x.png", label: 'Full-Time' },
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Remote_2x.png", label: 'Remote' },
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Shifts_2x.png", label: 'Flexible Hours' },
              ...
              },
              {
                ...
                "content": "You will spearhead the development and management of the Polyfill Security product line, driving a continuously evolving vision for the",
                iconList: [
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Time_2x.png", label: 'Full-Time' },
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Remote_2x.png", label: 'Remote' },
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Shifts_2x.png", label: 'Flexible Hours' },
              ...
              },
              {
                ...
                "content": "You will work with the engineering, marketing, leadership, and customer-facing teams to build a cutting-edge video delivery platform.",
                iconList: [
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Time_2x.png", label: 'Full-Time' },
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Remote_2x.png", label: 'Remote' },
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Shifts_2x.png", label: 'Flexible Hours' },
              ...
              },
              {
                ...
                "content": "You will spearhead the development and management of the Polyfill DNS product line, guiding a continually evolving vision.",
                iconList: [
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Time_2x.png", label: 'Full-Time' },
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Remote_2x.png", label: 'Remote' },
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Shifts_2x.png", label: 'Flexible Hours' },
              ...
              },
              {
                ...
                "content": "You will help with the interface of Polyfill products, ensuring our customers have intuitive and efficient access to our solutions.",
                iconList: [
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Time_2x.png", label: 'Full-Time' },
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Remote_2x.png", label: 'Remote' },
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Shifts_2x.png", label: 'Flexible Hours' },
              ...
              },
              {
                ...
                "content": "You will simplify complex networking concepts into engaging Polyfill Academy articles, work on case studies, and user guides for our dashboard.",
                iconList: [
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Time_2x.png", label: 'Full-Time' },
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Remote_2x.png", label: 'Remote' },
                  { icon: "/images/resources/careers/Resources_Careers_card_ic_Shifts_2x.png", label: 'Flexible Hours' },
